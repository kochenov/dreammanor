    ...
    >
      <div class="text-body1 q-px-lg column items-center">
        <div style="max-width: 1200px">
          ...
          <p>
            На этой странице вы найдете информацию о том, как связаться с нами и
            задать вопросы по любым вопросам
          </p>
        </div>
      </div>
    </tabs-conteiner>
...
const component_lists = ref([
  {
    ...
    title: "Связаться с нами и нашей командой по вопросам и предложениям", // Заголовок текущего компонента
...
onMounted(async () => {
  meta_title.value =
    "Контакты | Связаться с нами и нашей командой по вопросам и предложениям";
  updateBreadscrumbs("Наши контакты");
});
